...
\begin{titlepage}
  ...
  \vspace{2cm}
  {\scshape\Huge An Investigation Into the Performance and Alternatives to Machine Learning Techniques in an Economic Context \par}
  \vspace{2cm}
  {\Large\itshape Andre le Roux (22568948) \par}
  \vfill
  {\large 6 January 2024 \par}
\end{titlepage}
